...
class Codekind_codelists_model extends Base_module_model {
	...
	*/
	function form_fields($values = array())
	{
		...
		$fields['codeid'] = array('label' => '第二層', 'type' => 'array', 'class' => 'add_edit codekind/subcodelists combo', 'options' => $code_options, 'value' => $codekind_values, 'mode' => 'multi');
...
class Codekind_codelist_model extends Base_module_record {
